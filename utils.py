...
def get_training_dataloader(mean, std, batch_size=16, num_workers=2, shuffle=True):
    ...
    Args:
        mean: mean of cifar100 training datasets
        std: std of cifar100 training datasets
        path: path to cifar100 training python datasets
...
def get_test_dataloader(mean, std, batch_size=16, num_workers=2, shuffle=True):
    """ return training dataloader
    Args:
        mean: mean of cifar100 test datasets
        std: std of cifar100 test datasets
        path: path to cifar100 test python datasets
        batch_size: dataloader batchsize
        num_workers: dataloader num_works
        shuffle: whether to shuffle
...
def compute_mean_std(cifar100_dataset):
    """compute the mean and std of cifar100 datasets
    Args:
        cifar100_training_dataset or cifar100_test_dataset
        witch derived from class torch.utils.data

    Returns:
        a tuple contains mean, std value of entire datasets
    """
